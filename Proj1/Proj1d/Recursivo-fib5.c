...
//         switch case i.a-END
 ...
 printf("\n end pl/0");
    ...
    code[2].f = STO; code[2].l = 0; code[2].a = 15;
    code[3].f = LIT; code[3].l = 0; code[3].a = 1;
    code[4].f = STO; code[4].l = 0; code[4].a = 12;
    code[5].f = LIT; code[5].l = 0; code[5].a = 1;
    code[6].f = STO; code[6].l = 0; code[6].a = 13;
    code[7].f = LIT; code[7].l = 0; code[7].a = 2;
    code[8].f = STO; code[8].l = 0; code[8].a = 14;
    code[9].f = CAL; code[9].l = 0; code[9].a = 11;
    code[10].f = OPR; code[10].l = 0; code[10].a = 0;
    code[11].f = INT; code[11].l = 0; code[11].a = 9;
    ...
    code[16].f = STO; code[16].l = 0; code[16].a = 12;
    ...
    code[21].f = STO; code[21].l = 0; code[21].a = 14;
    code[22].f = LOD; code[22].l = 0; code[22].a = 13;
    code[23].f = STO; code[23].l = 0; code[23].a = 4;
    code[24].f = LOD; code[24].l = 0; code[24].a = 6;
    code[25].f = STO; code[25].l = 0; code[25].a = 15;
    code[26].f = LOD; code[26].l = 0; code[26].a = 14;
    code[27].f = LOD; code[27].l = 0; code[27].a = 6;
    code[28].f = OPR; code[28].l = 0; code[28].a = 8;
    code[29].f = JPC; code[29].l = 0; code[29].a = 31;
    code[30].f = CAL; code[30].l = 0; code[30].a = 11;
    code[31].f = LOD; code[31].l = 0; code[31].a = 4;
    code[32].f = STO; code[32].l = 1; code[32].a = 4;
