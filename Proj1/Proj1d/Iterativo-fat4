...
int main() {
    ...
    code[4].f = STO; code[4].l = 0; code[4].a = 10;
    code[5].f = LOD; code[5].l = 0; code[5].a = 3;
    code[6].f = STO; code[6].l = 0; code[6].a = 11;
    code[7].f = CAL; code[7].l = 0; code[7].a = 8;
    code[8].f = INT; code[8].l = 0; code[8].a = 5;
    code[9].f = LOD; code[9].l = 0; code[9].a = 3;
    code[10].f = LIT; code[10].l = 0; code[10].a = 1; 
    code[11].f = OPR; code[11].l = 0; code[11].a = 8;
    code[12].f = JPC; code[12].l = 0; code[12].a = 22;
    ...
    code[19].f = OPR; code[19].l = 0; code[19].a = 4; 
    code[20].f = STO; code[20].l = 0; code[20].a = 4; 
    code[21].f = JMP; code[21].l = 0; code[21].a = 9; 
    code[22].f = LOD; code[22].l = 0; code[22].a = 11; 
    code[23].f = STO; code[23].l = 2; code[23].a = 4; 
